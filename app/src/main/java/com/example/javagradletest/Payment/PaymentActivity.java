package com.example.javagradletest.Payment;
...
import static com.example.javagradletest.Common.ApplicationContext.getContext;
...
public class PaymentActivity extends AppCompatActivity {
    ...
    private void requestPickupHere() {
        ...
        com.example.javagradletest.models.Request request = new com.example.javagradletest.models.Request(userID, profile_photo2, profile_photo, username, 1, destination, currentLocation, 1, false, rideID, dateOnly, pickupTime, Float.parseFloat(cost.substring(2)), pickupLocation, licencePlate);
